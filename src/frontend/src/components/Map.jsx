    ...
    <div style={{ height, width: '100%' }}>
      ...
      >
        ...
        {routes && Array.isArray(routes) && routes.map((route) => (
          <Polyline
            key={route.id}
            positions={route.path || route.coordinates || []}
          ...
          >
            <Popup>
              <div className="text-sm">
                ...
                <p>Distance: {route.distance || route.distanceKm} km</p>
                <p>Duration: {route.estimatedTime || route.estimatedTimeMinutes || route.duration} min</p>
              </div>
            </Popup>
          </Polyline>
        ))}
        ...
        {/* Hazards */}
        {hazards && Array.isArray(hazards) && hazards.map((hazard) => (
          <Marker
            key={hazard.id}
            position={hazard.location || [hazard.latitude, hazard.longitude]}
